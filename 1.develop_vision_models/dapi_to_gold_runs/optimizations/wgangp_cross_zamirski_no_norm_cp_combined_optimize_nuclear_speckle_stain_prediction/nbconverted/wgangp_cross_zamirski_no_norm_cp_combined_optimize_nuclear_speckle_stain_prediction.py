...
def objective(trial):
    ...
    trainer_params = {"epochs": 40, "patience": 15, "example_images_per_epoch": 10}
    ...
    with mlflow.start_run(nested=True, run_name=f"trial {trial.number}"):
        ...
        trainer_params["batch_size"] = trial.suggest_int("batch_size", 8, 25)
        ...
        model_hyperparams["cp_loss_importance"] = trial.suggest_int(
            "cp_loss_importance", 1, 100
        )
